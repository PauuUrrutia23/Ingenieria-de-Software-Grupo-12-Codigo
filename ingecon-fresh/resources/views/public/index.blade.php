...
@section('content')
    ...
    {{-- ================================================================
         SECCIÓN: Colaboradores (#colaboradores) — RF14
         Renderizada server-side con datos obtenidos de la Base de Datos.
         ================================================================ --}}
    <section
        id="colaboradores"
        class="pt-20 pb-16 bg-white"
        aria-labelledby="colaboradores-titulo"
    >
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16">

            <div class="text-center mb-10">
                <h2 id="colaboradores-titulo" class="text-3xl font-bold text-slate-900 mb-3">
                    Colaboradores
                </h2>
