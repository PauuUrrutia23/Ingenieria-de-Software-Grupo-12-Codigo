...
> **Acceso a datos:** `ProyectoController` recibe `DBRouterController` (`02b_dbrouter_controller.md`) por constructor y delega en él toda consulta. La construcción de la query con filtros ILIKE vive ahora dentro del router; el controlador solo arma el JSON. No hay llamadas directas a Eloquent en este archivo.  
