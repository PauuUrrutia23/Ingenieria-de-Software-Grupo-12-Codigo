        ...
        >
            ...
            <div class="shrink-0 flex items-center gap-2">
                ...
                <a
                    ...
                    class="flex items-center gap-1.5 bg-white hover:bg-slate-50
                           active:bg-slate-100 text-slate-700 text-sm font-medium
                           px-3 py-2 rounded-lg border border-slate-300
                           transition-colors duration-150
                           focus:outline-none focus-visible:ring-2
                           focus-visible:ring-blue-400 focus-visible:ring-offset-2"
                    aria-label="Visualizar certificado {{ $cert->codigo_lote }} en PDF"
                >
                    <svg
                        class="w-4 h-4"
                        xmlns="http://www.w3.org/2000/svg"
